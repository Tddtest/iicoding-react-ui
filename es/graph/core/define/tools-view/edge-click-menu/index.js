...
var EdgeClickMenu = /*#__PURE__*/function (_ToolsView$ToolItem) {
  _inherits(EdgeClickMenu, _ToolsView$ToolItem);
  var _super = _createSuper(EdgeClickMenu);
  function EdgeClickMenu() {
    var _this;
    _classCallCheck(this, EdgeClickMenu);
  ...
  _createClass(EdgeClickMenu, [{
    ...
    value: function delegateEvents() {
      ...
      return _get(_getPrototypeOf(EdgeClickMenu.prototype), "delegateEvents", this).call(this);
    }
  }, {
    key: "onRemove",
  ...
  return EdgeClickMenu;
}(ToolsView.ToolItem);
EdgeClickMenu.config({
  tagName: 'div',
  isSVGElement: false,

...
var NodeRightMenu = /*#__PURE__*/function (_ToolsView$ToolItem) {
  _inherits(NodeRightMenu, _ToolsView$ToolItem);
  var _super = _createSuper(NodeRightMenu);
  function NodeRightMenu() {
    var _this;
    _classCallCheck(this, NodeRightMenu);
    ...
    _defineProperty(_assertThisInitialized(_this), "onMouseDown", function (e) {
      if (e.target) {
        ...
        if (id) {
          ...
          var modalClassName = "icd-modal-".concat(id);
          var modalNode = document.getElementsByClassName(modalClassName)[0];
  ...
  _createClass(NodeRightMenu, [{
    ...
    value: function delegateEvents() {
      ...
      return _get(_getPrototypeOf(NodeRightMenu.prototype), "delegateEvents", this).call(this);
    }
  }, {
    key: "onRemove",
  ...
  return NodeRightMenu;
}(ToolsView.ToolItem);
NodeRightMenu.config({
  tagName: 'div',
  isSVGElement: false,

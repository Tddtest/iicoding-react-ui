...
var B = (props) => {
  const { bgColor, pageSize = 6, maskStyle, ...other } = props;
  ...
  return /* @__PURE__ */ React.createElement(
    "div",
    {
      ...
      style: Object.assign(maskStyle || {}, other.maskBgColor ? { backgroundColor: other.maskBgColor } : {})
    },
    /* @__PURE__ */ React.createElement("div", { className: "icd-load-box" }, /* @__PURE__ */ React.createElement("div", { className: "loader", style: styleVal }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("ul", null, pageNode))), /* @__PURE__ */ React.createElement("div", { className: "load-text" }, (other == null ? void 0 : other.text) || "Loading..."))
  );
};

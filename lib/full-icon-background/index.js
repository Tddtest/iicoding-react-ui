...
var F = (props) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: svgRef, style: containerStyle, className: "icd-icon-blur", ...other }, icon, /* @__PURE__ */ React.createElement("span", { className: "icd-bg", style: bgStyle }), /* @__PURE__ */ React.createElement("span", { className: "icd-bg-ff" }));
};

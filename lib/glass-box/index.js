...
var G = (props) => {
  ...
  (0, import_react.useEffect)(() => {
    if (boxRef.current) {
      const { backdropFilter, backgroundColor, boxShadow } = window.getComputedStyle(
        boxRef.current
      );
      const st = {};
      ...
      if (bgOpacity) {
        ...
        if (backgroundColor.includes("rgba")) {
          ...
          newBgColor = `rgba(${newBgColor.slice(4, newBgColor.length - 1)}, ${bgOpacity})`;
        } else {
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { ref: boxRef, style, className: (0, import_classnames.default)("icd-g-b", className), ...other }, children);
};

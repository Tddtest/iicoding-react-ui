...
// src/graph/core/define/tools-view/edge-click-menu/index.tsx
var edge_click_menu_exports = {};
__export(edge_click_menu_exports, {
  default: () => edge_click_menu_default
});
module.exports = __toCommonJS(edge_click_menu_exports);
...
var EdgeClickMenu = class extends import_x6.ToolsView.ToolItem {
  constructor() {
    super(...arguments);
    this.closeMenu = () => {
...
EdgeClickMenu.config({ tagName: "div", isSVGElement: false, className: "icd-node-click-menu" });
var edge_click_menu_default = EdgeClickMenu;

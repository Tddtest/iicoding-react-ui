...
// src/graph/core/define/tools-view/edge-right-menu/index.tsx
var edge_right_menu_exports = {};
__export(edge_right_menu_exports, {
  default: () => edge_right_menu_default
});
module.exports = __toCommonJS(edge_right_menu_exports);
...
var EdgeRightMenu = class extends import_x6.ToolsView.ToolItem {
  constructor() {
    super(...arguments);
    this.closeMenu = () => {
...
EdgeRightMenu.config({ tagName: "div", isSVGElement: false, className: "icd-node-click-menu" });
var edge_right_menu_default = EdgeRightMenu;

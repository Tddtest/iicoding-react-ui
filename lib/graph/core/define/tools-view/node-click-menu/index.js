...
// src/graph/core/define/tools-view/node-click-menu/index.tsx
var node_click_menu_exports = {};
__export(node_click_menu_exports, {
  default: () => node_click_menu_default
});
module.exports = __toCommonJS(node_click_menu_exports);
...
var NodeClickMenu = class extends import_x6.ToolsView.ToolItem {
  constructor() {
    super(...arguments);
    this.closeMenu = () => {
...
NodeClickMenu.config({ tagName: "div", isSVGElement: false, className: "icd-node-click-menu" });
var node_click_menu_default = NodeClickMenu;

...
var import_ant_utils = require("../../../../../ant-utils");
...
var N = (props) => {
  ...
  const [disabled, setDisabled] = (0, import_react.useState)([2, 5].includes((_b = (_a = node.data) == null ? void 0 : _a.execution) == null ? void 0 : _b.status));
  ...
  const handleMenuClick = (key) => {
    ...
    switch (key) {
      ...
      case "startThatNode": {
        ...
        if (!info.code) {
          import_ant_utils.utils.message.error("当前节点没有任何可执行代码，请先为该节点添加代码！");
        } else {
          handleExecuteCode();
        }
        onClose();

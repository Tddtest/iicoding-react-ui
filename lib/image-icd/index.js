...
var I = (props) => {
  const { src, width, height, noBorder, fallback, alt, className, ...other } = props;
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { width, height }, className: "i" }, /* @__PURE__ */ React.createElement(
    "img",
    {
      ref: imgRef,

...
var I = (props) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "i" }, /* @__PURE__ */ import_react.default.createElement(
    "img",
    {
      ref: imgRef,
  ...
  ), /* @__PURE__ */ import_react.default.createElement("div", { className: "load" }));
};
var ImageIcd = (0, import_react.memo)(I);

...
var C = (props) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_react_syntax_highlighter.PrismLight, { style: import_dracula.default, ...other }, children);
};
var CodeBlockHighlight = (0, import_react.memo)(C);

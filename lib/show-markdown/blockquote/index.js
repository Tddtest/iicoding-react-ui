...
var B = (props) => {
  ...
  return /* @__PURE__ */ React.createElement("blockquote", { className: "icd-blockquote" }, !(0, import_utils.isObject)(child) || !(0, import_utils.isFunction)(child) ? child : Array.isArray(children) ? React.cloneElement(children[0], {
    isBlockquote: true
  }) : children);
};

...
var H = (props) => {
  ...
  const tagProps = React.useMemo(() => {
    ...
    let idStr = localStorage.getItem(key || "") || "";
    if (!idStr) {
      idStr = localStorage.getItem(`bk-${key}`) || "";
    }
  ...
  const tagChildren = /* @__PURE__ */ React.createElement("div", { className: "icd-title-box" }, /* @__PURE__ */ React.createElement(import_full_icon_background.default, { ...hIcon[level] }), /* @__PURE__ */ React.createElement("span", { className: "icd-title-text" }, children));

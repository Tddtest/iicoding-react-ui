...
var import_mark = __toESM(require("./mark"));
...
var import_sup = __toESM(require("./sup"));
    ...
    import_markdown_to_jsx.default,
    {
      ...
      options: {
        ...
        overrides: {
          ...
          input: { component: import_input.default },
          sup: { component: import_sup.default },
          sub: { component: import_sub.default },
          mark: { component: import_mark.default },
          ...options == null ? void 0 : options.overrides
        }
      }
    },
    mdContent

...
var L = (props) => {
  const { children, selfIdx, parentIdx = 1, isOl } = props;
  ...
  return /* @__PURE__ */ React.createElement(import_style.Item, { ...props, isUl: !isOl, idx: selfIdx || 0 }, selfIdx && /* @__PURE__ */ React.createElement(import_style.SerialNumber, null, idx), !isOl && /* @__PURE__ */ React.createElement(import_style.Disorder, null, prefix[parentIdx]), /* @__PURE__ */ React.createElement(import_style.ListText, null, getChildren()));
};
var Li = React.memo(L);
Li.displayName = "li";
var li_default = Li;

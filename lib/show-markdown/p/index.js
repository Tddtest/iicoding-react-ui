...
var import_constants = require("../../show-markdown/constants");
...
var P = (props) => {
  ...
  if (Array.isArray(children) && children[0]) {
    let [str] = children;
    const noReplaceStr = `'${import_constants.PLACEHOLDER_REPLACE_STR}'`;
    const replaceStr = import_constants.LINE_REPLACE_STR;

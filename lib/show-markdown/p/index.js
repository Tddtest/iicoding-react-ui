...
var P = (props) => {
  ...
  if (isStrong && !isBlockquote) {
    return /* @__PURE__ */ React.createElement("div", { className: "icd-note" }, /* @__PURE__ */ React.createElement("p", { className: "icd-tips" }, /* @__PURE__ */ React.createElement(
  ...
  if (Array.isArray(children) && children[0]) {
    ...
    if ((0, import_utils.isString)(str)) {
      ...
      if (str.includes("\n")) {
        ...
        return /* @__PURE__ */ React.createElement("p", { className: "icd-p" }, child.map((str2, idx) => {
          return /* @__PURE__ */ React.createElement("span", { className: "icd-span", key: `${str2}-${idx.toString()}` }, str2);
        }));
      }
    }
  }
  return /* @__PURE__ */ React.createElement("p", { className: "icd-p" }, children);
};

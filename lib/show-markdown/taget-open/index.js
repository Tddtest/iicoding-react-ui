...
var T = (props) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement("span", { className: "icd-href" }, /* @__PURE__ */ import_react.default.createElement(
    "a",
    {
    ...
    import_react.Children.map(children, (c) => {
      var _a, _b;
      if (((_a = c == null ? void 0 : c.props) == null ? void 0 : _a.src) && ((_b = c == null ? void 0 : c.props) == null ? void 0 : _b.alt)) {
        return (0, import_react.cloneElement)(c, { isAnchor: true });
      }
      return c;
    })
  ));
};
var TargetOpen = (0, import_react.memo)(T);
